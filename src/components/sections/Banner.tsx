			...
			<div className="container">
				<div className="banner-wrapper">
					<div className="banner-content">
						...
						<p>
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam dolor iure,
							repellendus eveniet error excepturi.
						</p>
					...
					<div className="banner-images">
						<Image src={BalanceCard} alt="payment-solutions-balance-card" />
						<Image src={CreditCard} alt="payment-solutions-credit-card" />
						<Image src={WorkerCard} alt="payment-solutions-worker-card" />
					</div>
				</div>
			</div>
		</section>
